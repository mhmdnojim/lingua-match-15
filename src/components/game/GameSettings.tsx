...
import { Eye, EyeOff, Volume2, VolumeX, Music, Music2, Mic, Crown, Type, Shuffle, ListOrdered, SlidersHorizontal, ChevronUp, ChevronDown, Columns3, Palette, Search, Pencil, RefreshCw } from 'lucide-react';
...
export const GameSettings: React.FC<GameSettingsProps> = ({
  ...
  return (
    <div className={cn(settingsOpen ? 'space-y-2' : '', className)}>
      ...
      {settingsOpen && (
        <div className="flex flex-nowrap items-center justify-start gap-2 overflow-x-auto rounded-lg border border-border bg-card/60 p-2">
      {extraControls}
