...
export const LANGUAGES: LanguageDef[] = [
  ...
  { code: 'ar', name: 'Arabic', native: 'العربية', locale: 'ar-SA', rtl: true, fontClass: 'font-arabic', romanizationLabel: 'Latin', short: 'ع' },
  { code: 'ar-latin', name: 'Arabic Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'ar', short: 'AR-L' },
  { code: 'es', name: 'Spanish', native: 'Español', locale: 'es-ES', short: 'ES' },
  { code: 'fr', name: 'French', native: 'Français', locale: 'fr-FR', romanizationLabel: 'Latin', short: 'FR' },
  { code: 'de', name: 'German', native: 'Deutsch', locale: 'de-DE', romanizationLabel: 'Latin', short: 'DE' },
  { code: 'it', name: 'Italian', native: 'Italiano', locale: 'it-IT', short: 'IT' },
  { code: 'pt', name: 'Portuguese', native: 'Português', locale: 'pt-BR', short: 'PT' },
  { code: 'nl', name: 'Dutch', native: 'Nederlands', locale: 'nl-NL', romanizationLabel: 'Latin', short: 'NL' },
  { code: 'sv', name: 'Swedish', native: 'Svenska', locale: 'sv-SE', short: 'SV' },
  { code: 'pl', name: 'Polish', native: 'Polski', locale: 'pl-PL', short: 'PL' },
  { code: 'ru', name: 'Russian', native: 'Русский', locale: 'ru-RU', romanizationLabel: 'Latin', short: 'RU' },
  ...
  { code: 'ko', name: 'Korean', native: '한국어', locale: 'ko-KR', romanizationLabel: 'Latin', short: '한' },
  { code: 'hi', name: 'Hindi', native: 'हिन्दी', locale: 'hi-IN', romanizationLabel: 'Latin', short: 'HI' },
  { code: 'ur', name: 'Urdu', native: 'اردو', locale: 'ur-PK', rtl: true, fontClass: 'font-arabic', romanizationLabel: 'Latin', short: 'UR' },
  { code: 'fa', name: 'Persian', native: 'فارسی', locale: 'fa-IR', rtl: true, fontClass: 'font-arabic', romanizationLabel: 'Latin', short: 'FA' },
  { code: 'he', name: 'Hebrew', native: 'עברית', locale: 'he-IL', rtl: true, romanizationLabel: 'Latin', short: 'HE' },
  { code: 'id', name: 'Indonesian', native: 'Bahasa Indonesia', locale: 'id-ID', romanizationLabel: 'Latin', short: 'ID' },
  { code: 'ms', name: 'Malay', native: 'Bahasa Melayu', locale: 'ms-MY', romanizationLabel: 'Latin', short: 'MS' },
  { code: 'vi', name: 'Vietnamese', native: 'Tiếng Việt', locale: 'vi-VN', romanizationLabel: 'Latin', short: 'VI' },
  { code: 'bg', name: 'Bulgarian', native: 'Български', locale: 'bg-BG', romanizationLabel: 'Latin', short: 'BG' },
  { code: 'kk', name: 'Kazakh', native: 'Қазақша', locale: 'kk-KZ', romanizationLabel: 'Latin', short: 'KK' },
  { code: 'tk', name: 'Turkmen', native: 'Türkmençe', locale: 'tk-TM', romanizationLabel: 'Latin', short: 'TK' },
  { code: 'th', name: 'Thai', native: 'ไทย', locale: 'th-TH', romanizationLabel: 'Latin', short: 'TH' },
  { code: 'ru-latin', name: 'Russian Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'ru', short: 'RU-L' },
  { code: 'ko-romaja', name: 'Korean Romaja', native: 'Romaja', locale: 'en-US', romanizationOf: 'ko', short: 'KO-R' },
  { code: 'hi-latin', name: 'Hindi Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'hi', short: 'HI-L' },
  { code: 'ur-latin', name: 'Urdu Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'ur', short: 'UR-L' },
  { code: 'fa-latin', name: 'Persian Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'fa', short: 'FA-L' },
  { code: 'he-latin', name: 'Hebrew Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'he', short: 'HE-L' },
  { code: 'th-latin', name: 'Thai Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'th', short: 'TH-L' },
  { code: 'bg-latin', name: 'Bulgarian Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'bg', short: 'BG-L' },
  { code: 'kk-latin', name: 'Kazakh Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'kk', short: 'KK-L' },
  { code: 'nl-latin', name: 'Dutch Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'nl', short: 'NL-L' },
  { code: 'fr-latin', name: 'French Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'fr', short: 'FR-L' },
  { code: 'de-latin', name: 'German Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'de', short: 'DE-L' },
  { code: 'id-latin', name: 'Indonesian Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'id', short: 'ID-L' },
  { code: 'ms-latin', name: 'Malay Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'ms', short: 'MS-L' },
  { code: 'tk-latin', name: 'Turkmen Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'tk', short: 'TK-L' },
  { code: 'vi-latin', name: 'Vietnamese Latin', native: 'Latin', locale: 'en-US', romanizationOf: 'vi', short: 'VI-L' },
];
